...
public class CellPhonePageSteps {
    ...
    public void iFillAllMandatoryFieldOfRegistration() {
        ...
        new RegisterPage().selectMonthOfBirth("March");
        new RegisterPage().selectYearOfBirth("1994");
    ...
    public void iFillAllMandatoryFieldOnCheckOutPage() {
        ...
        new OnePageCheckoutPage().selectState("Norfolk");
        new OnePageCheckoutPage().selectCity("London");
        new OnePageCheckoutPage().enterAddressLine1("3 Clovelly Road");
        new OnePageCheckoutPage().enterZipCode("NR67ET");
        new OnePageCheckoutPage().enterPhoneNumber("0145698756");
    }
    ...
    public void iFillAllVisaCardDetail() {
        new OnePageCheckoutPage().enterCardHolderName("Mr Raja Babu");

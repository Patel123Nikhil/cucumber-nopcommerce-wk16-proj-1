...
public class DesktopPageSteps {
    ...
    public void iFillAllMandatoryFieldOnCheckOutAsGuestPage() {
        new OnePageCheckoutPage().enterFirstName("Raja");
        new OnePageCheckoutPage().enterLastName("Babu");
        new OnePageCheckoutPage().enterEmail("rajababu@gmail.com");
        new OnePageCheckoutPage().selectCountry("United Kingdom");
        new OnePageCheckoutPage().selectCity("Norwich");
        new OnePageCheckoutPage().enterAddressLine1("4 Clovelly Road");
        new OnePageCheckoutPage().enterZipCode("NR67Et");
        new OnePageCheckoutPage().enterPhoneNumber("0145896321");
    ...
    public void iFillAllCardDetail() {
        new OnePageCheckoutPage().enterCardHolderName(" Raja Babu");
        new OnePageCheckoutPage().enterCardNumber("5555 5555 5555 4444");
        new OnePageCheckoutPage().selectExpiryMonthOfCard("04");
        new OnePageCheckoutPage().selectExpiryYearOfCard("2025");
        new OnePageCheckoutPage().enterCardCode("183");
    }
